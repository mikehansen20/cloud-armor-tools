...
* [protected_resource_count_by_project.py](https://github.com/mikehansen20/cloud-armor-tools/blob/main/protected_resource_count_by_project.py) - Quickly find the amount of potential Protected Resources that Cloud Armor Enterprise would cover at the project level.
